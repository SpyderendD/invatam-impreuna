...
export default function HeartRating({
  ...
  const handleVote = async (val: number) => {
    ...
    try {
      ...
      if (!res.ok) {
        // EROARE: Ai votat deja
        setUserVote(previousVote); // Resetăm vizual
  ...
  return (
    ...
    >
      ...
      {/* 1. BACKGROUND GLOW (Culoare dinamică) */}
      <motion.div 
      ...
      {/* 3. CARD PRINCIPAL (Glassmorphism) */}
      <motion.div 
        ...
        <div className="flex items-center gap-1 sm:gap-2" onMouseLeave={() => setHover(null)}>
          {Array.from({ length: max }).map((_, i) => {
            ...
            return (
              ...
              >
                <svg viewBox="0 0 24 24" className="absolute w-full h-full text-white/20">
            ...
            <div className="fixed inset-0 z-[9999] flex items-center justify-center px-4">
                ...
                >
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <p className="text-sm text-gray-400">Resetezi toate voturile și permiți revotarea?</p>
