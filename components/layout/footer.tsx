...
// Componenta pentru coloanele de link-uri
...
// Componenta pentru iconițele sociale
const SocialIcon = ({ href, icon, label }: { href: string; icon: React.ReactNode; label: string }) => (
  <Link href={href} target="_blank" rel="noopener noreferrer" aria-label={label} className="h-9 w-9 rounded-lg bg-background flex items-center justify-center text-muted-foreground hover:bg-primary hover:text-primary-foreground transition-all transform hover:scale-110">
    {icon}
  </Link>
);
...
// --- COMPONENTA PRINCIPALĂ A FOOTER-ULUI ---
