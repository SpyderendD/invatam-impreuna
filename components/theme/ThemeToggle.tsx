...
export default function ThemeToggle() {
  ...
  // Placeholder pentru a evita eroarea de hidratare
  if (!mounted) {
    return <div className="w-[5em] h-[30px] md:w-[7em] md:h-[44px]" />;
  }

  // Determinăm dacă tema curentă e dark
    ...
    <div className="relative inline-block z-50">
      ...
      >
        <input 
          ...
          checked={isDark}
          // Schimbare SIMPLĂ, fără animații JS care blochează mobilul
          onChange={() => setTheme(isDark ? 'light' : 'dark')} 
        />
        
        {/* SVG Container - Design-ul tău preferat */}
        <div className="w-[5em] h-[30px] md:w-[7em] md:h-[44px] transition-all duration-300">
            ...
            <g transform="translate(3.5 3.5)" data-name="Component 15 – 1" id="Component_15_1">
                ...
                >
                <g data-name="sun" id="sun" className={`transition-opacity duration-300 ${isDark ? 'opacity-0' : 'opacity-100'}`}>
                ...
                <g data-name="moon" id="moon" className={`transition-opacity duration-300 ${isDark ? 'opacity-100' : 'opacity-0'}`}>
