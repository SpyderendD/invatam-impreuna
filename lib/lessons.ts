...
import { PenSquare, BookOpen, Languages, Waypoints, Calculator, Square, Sparkles, Shapes, Scaling, InfinityIcon, Ruler, Cuboid } from "lucide-react";
...
// ============================================================================
// == DATE COMPLETE PENTRU LIMBA ȘI LITERATURA ROMÂNĂ
// ============================================================================
export const romanaChapters: Chapter[] = [
  {
    ...
    icon: React.createElement(PenSquare, { className: "h-8 w-8 text-primary" }),
    lessons: [
  ...
  },
  {
    ...
    icon: React.createElement(Languages, { className: "h-8 w-8 text-primary" }),
    lessons: [
  ...
  },
  {
    ...
    icon: React.createElement(Waypoints, { className: "h-8 w-8 text-primary" }),
    lessons: [
  ...
  },
  {
    ...
    icon: React.createElement(Sparkles, { className: "h-8 w-8 text-primary" }),
    lessons: [
...
// ============================================================================
// == DATE PENTRU MATEMATICĂ (exemplu)
// ============================================================================
export const matematicaChapters: Chapter[] = [
  {
    ...
    icon: React.createElement(InfinityIcon, { className: "h-8 w-8 text-primary" }),
    lessons: [
  ...
  },
  {
    ...
    icon: React.createElement(Calculator, { className: "h-8 w-8 text-primary" }),
    lessons: [
  ...
  },
  {
    ...
    icon: React.createElement(Ruler, { className: "h-8 w-8 text-primary" }),
    lessons: [
  ...
  },
  {
    ...
    icon: React.createElement(Cuboid, { className: "h-8 w-8 text-primary" }),
    lessons: [
...
// ============================================================================
// == OBIECT CENTRALIZAT PENTRU TOATE MATERIILE
// ============================================================================
