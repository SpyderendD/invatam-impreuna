...
const lessons =[
    ...
    { slug: "test-evaluare-initiala-clasa-5", icon: faDownload, title: "Test de Evaluare Inițială", pdfFile: "test-evaluare-initiala-clasa-5.pdf" },
    { slug: "sistem-de-calcul", icon: faLaptop, title: "1. Ce este un Sistem de Calcul?", pdfFile: "sistem_de_calcul.pdf" },
    { slug: "istoric-calculatoare", icon: faHourglassHalf, title: "2. O Scurtă Istorie a Calculatoarelor", pdfFile: "sisteme_de_calcul_istoric.pdf" },
    { slug: "dispozitive-de-intrare", icon: faKeyboard, title: "3. Dispozitive de Intrare (Input)", pdfFile: "dispozitive_de_intrare.pdf" },
    { slug: "dispozitive-de-iesire", icon: faPrint, title: "4. Dispozitive de Ieșire (Output)", pdfFile: "dispozitive_de_iesire.pdf" },
    { slug: "dispozitive-mixte", icon: faHeadset, title: "5. Dispozitive Mixte (Intrare/Ieșire)", pdfFile: "dispozitive_de_intrare-iesire.pdf" },
    { slug: "descrierea-software", icon: faPuzzlePiece, title: "6. Înțelegerea Părții Software", pdfFile: "descrierea_componentei_software.pdf" },
    { slug: "internetul", icon: faGlobeEurope, title: "7. Internetul: Cum ne Conectăm?", pdfFile: "internetul.pdf" },
    { slug: "world-wide-web", icon: faNetworkWired, title: "8. Explorând World Wide Web (WWW)", pdfFile: "serviciul_world_wide_web.pdf" },
    { slug: "cautarea-informatiilor", icon: faSearchLocation, title: "9. Arta Căutării de Informații Online", pdfFile: "cautarea_informatiilor_pe_internet.pdf" },
    { slug: "editare-grafica", icon: faPalette, title: "10. Introducere în Grafica pe Calculator", pdfFile: "editoare_grafice.pdf" },
    { slug: "instrumente-de-desenare", icon: faPaintBrush, title: "11. Unelte Digitale pentru Desen", pdfFile: "instrumente_de_desenare.pdf" },
    ...
    { slug: "algoritmi-proprietati", icon: faLightbulb, title: "13. Ce sunt Algoritmii și la ce Folosesc?", pdfFile: "algoritmi_proprietăți.pdf" },
    ...
    { slug: "expresii-aritmetice", icon: faCalculator, title: "15. Facem Calcule: Expresii Aritmetice", pdfFile: "expresii_aritmetice.pdf" },
    { slug: "expresii-logice", icon: faBrain, title: "16. Gândire Logică: Expresii Adevărat/Fals", pdfFile: "expresii_logice.pdf" },
    { slug: "operatori-relationali", icon: faBalanceScale, title: "17. Operatori Relaționali", pdfFile: "operatori_relationali.pdf" },
    { slug: "structura-liniara", icon: faRoute, title: "18. Structura Liniară", pdfFile: "structura_liniară.pdf" },
    { slug: "mediu-grafic-interactiv", icon: faWindowMaximize, title: "19. Medii Vizuale pentru Programare", pdfFile: "prezentarea_mediuului_grafic_interactiv.pdf" },
    { slug: "structura-alternativa", icon: faCodeBranch, title: "20. Structura Alternativă", pdfFile: "structura_alternativa.pdf" },
    { slug: "reprezentarea-deciziilor", icon: faProjectDiagram, title: "21. Cum Reprezentăm Deciziile?", pdfFile: "Reprezentarea_structurii_alternative_int.pdf" },
    { slug: "aplicatii-scratch", icon: faCat, title: "22. Să Creăm cu Scratch!", pdfFile: "aplicatii_scratch.pdf" },
    { slug: "recapitulare-generala", icon: faClipboardCheck, title: "23. Recapitulare: Ce Am Învățat?", pdfFile: "recapitulare.pdf" },
    { slug: "recapitulare-finala", icon: faAward, title: "Recapitulare Finală ;)", pdfFile: "recapitulare_finala.pdf" },
];
