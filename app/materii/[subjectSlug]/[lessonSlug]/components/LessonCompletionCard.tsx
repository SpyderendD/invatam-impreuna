...
import { CheckCircle, Loader2, PencilRuler, Sparkles } from 'lucide-react';
...
export function LessonCompletionCard({ lesson, subjectSlug, isCompleted, isLoading, onToggleCompletion }: LessonCompletionCardProps) {
  return (
    <motion.div
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-6">
        <Button size="lg" variant={isCompleted ? "secondary" : "default"} onClick={onToggleCompletion} disabled={isLoading}>
