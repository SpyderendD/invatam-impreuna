...
export default function LoginPage() {
  ...
  const handleAuthError = (error: any, provider: string) => {
    ...
    toast({
      ...
      description: 'Datele introduse sunt incorecte. Te rugăm să verifici emailul și parola.',
      variant: 'destructive'
    });
  }
        ...
        >
          <Card className="bg-card/80 dark:bg-card/60 backdrop-blur-lg border-white/20 shadow-2xl">
            ...
            <CardContent>
              ...
              <div className="mt-6 text-center text-sm"><span className="text-muted-foreground">Nu ai un cont?{' '}</span><Link href="/register" className="font-medium text-primary underline-offset-4 hover:underline">Înregistrează-te</Link></div>
            </CardContent>
          </Card>
        </motion.div>
      </main>
